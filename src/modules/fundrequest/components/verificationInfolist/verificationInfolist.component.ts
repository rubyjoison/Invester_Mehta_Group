...
@Component({
  selector: 'sb-verificationInfolist',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './verificationInfolist.component.html',
  styleUrls: ['verificationInfolist.component.scss'],
})
export class VerificationListTableComponent implements OnInit {
