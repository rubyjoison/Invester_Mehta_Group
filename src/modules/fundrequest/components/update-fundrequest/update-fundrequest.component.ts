...
@Component({
    selector: 'sb-update-fundrequest',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './update-fundrequest.component.html',
    styleUrls: ['update-fundrequest.component.scss'],
})
export class UpdateFundRequestTableComponent implements OnInit {
